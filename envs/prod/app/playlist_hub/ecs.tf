  ...
  [
    ...
    },
    {
      ...
      secrets = [
        {
          name = "APP_KEY"
          valueFrom = "/${local.system_name}/${local.env_name}/${local.env_name}/${local.service_name}/APP_KEY"
        }
      ]
...
resource "aws_ecs_service" "this" {
  ...
  load_balancer {
    ...
    container_port = 80
    target_group_arn = data.terraform_remote_state.routing_api_musichub_com.outputs.lb_target_group_foobar_arn
  }
