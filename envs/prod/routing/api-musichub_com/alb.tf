resource "aws_lb" "this" {
  ...
  tags = {
    Name = "${local.name_prefix}-api-musichub-com"
  }
}
...
resource "aws_lb_listener" "https" {
  ...
  default_action {
    type             = "forward"
    target_group_arn = aws_lb_target_group.musichub.arn
  }
}
...
resource "aws_lb_target_group" "musichub" {
  name = "${local.name_prefix}-musichub"
